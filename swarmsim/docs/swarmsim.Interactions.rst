...
The Interactions package implements various force models and interaction mechanisms between
agents in multi-agent simulations. These interactions form the foundation of collective
behaviors such as flocking, schooling, herding, and complex emergent patterns.

.. automodule:: swarmsim.Interactions
   :members:
   :undoc-members:
   :show-inheritance:
...
All interaction classes inherit from the base interaction interface, ensuring
consistent integration with simulators and populations.
...
.. automodule:: swarmsim.Interactions.lennard_jones
   :members:
   :undoc-members:
   :show-inheritance:
...
.. automodule:: swarmsim.Interactions.power_law_interaction
   :members:
   :undoc-members:
   :show-inheritance:
